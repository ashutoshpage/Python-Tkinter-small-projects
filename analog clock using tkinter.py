...
def ghadi_bana(hourr, minutee, secondd, kalam): #function with 4 parameters
...
while True:
    hourr = int(time.strftime("%I")) #setting the hour from the time module
    ...
    ghadi_bana(hourr, minutee, secondd, kalam) #calling the ghanta_bana() function with the given parameters
